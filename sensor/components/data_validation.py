...
class DataValidation:
    ...
    def initiate_data_validation(self)->artifact_entity.DataValidationArtifact:
        ...
        try:
            ...
            # Drop missing values columns from base dataframe
            ...
            # Drop missing values columns from train dataframe
            ...
            # Drop missing values columns from test dataframe
            ...
            # Preparing artifact
            logging.info(f"Preparing Data Validation artifacts")
